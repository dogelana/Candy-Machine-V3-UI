...
const SolanaGatewayProvider = ({ children = null, wallet, connection, cluster = 'mainnet-beta', gatekeeperNetwork, wrapper, logo, stage = 'prod', redirectUrl, broadcastTransaction, gatekeeperSendsTransaction, handleTransaction, expiryMarginSeconds, options = { autoShowModal: true }, }) => {
    var _a, _b;
    const chainImpl = (0, react_1.useMemo)(() => {
        ...
        return undefined;
    }, [connection, cluster, (_a = wallet === null || wallet === void 0 ? void 0 : wallet.publicKey) === null || _a === void 0 ? void 0 : _a.toBase58(), gatekeeperNetwork === null || gatekeeperNetwork === void 0 ? void 0 : gatekeeperNetwork.toBase58(), stage]);
