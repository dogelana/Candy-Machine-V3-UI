...
const GatewayProvider = ({ children = null, wallet, chainImplementation, wrapper, logo, stage = 'prod', redirectUrl, gatekeeperNetwork, options = { autoShowModal: true }, ownerSigns, expiryMarginSeconds, }) => {
    ...
    const [state, dispatch] = (0, react_1.useReducer)(useReducer_1.default, {
        ...
        expiryMarginSeconds: expiryMarginSeconds !== undefined
            ? expiryMarginSeconds
            : (0, networkConfig_1.default)({ gatekeeperNetworkAddress, stage }).tokenExpirationMarginSeconds,
    });
    logger_1.default.debug(`state.expiryMarginSeconds: ${state.expiryMarginSeconds}`);
