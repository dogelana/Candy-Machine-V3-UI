import { CivicPassMessageResponse, GatewayToken, RootState, WalletAdapter, ChainErrorResponse } from '../types';
import type { Action } from '../useReducer';
export type UseCivicPassIssuanceAction = {
