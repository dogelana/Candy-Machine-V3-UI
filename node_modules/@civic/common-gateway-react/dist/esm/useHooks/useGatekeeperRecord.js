...
const useGetGatekeeperRecord = ({ wallet, gatekeeperClient, httpConfig, networkConfig, }, state, dispatch) => {
    ...
    const getAction = (gatekeeperRecordState) => {
        ...
        return actions[gatekeeperRecordState === null || gatekeeperRecordState === void 0 ? void 0 : gatekeeperRecordState.state];
    };
    /**
    ...
    const dispatchGatekeeperRecord = async () => {
        ...
        try {
            ...
            logDebug('Gatekeeper record response state: ', types_1.GatekeeperAPIStatus[record === null || record === void 0 ? void 0 : record.state]);
